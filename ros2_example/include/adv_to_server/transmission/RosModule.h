...
class RosModuleTraffic
{
  public:
    ...
    RegisterCallBack (void
                      (*cb1) (const msgs::msg::DetectedObjectArray::SharedPtr),
                      void
                      (*cb2) (const msgs::msg::LidLLA::SharedPtr),
                      void
                      (*cb3) (const msgs::msg::VehInfo::SharedPtr),
                      void
                      (*cb4) (const geometry_msgs::msg::PoseStamped::SharedPtr),
                      void
                      (*cb5) (const std_msgs::msg::String::SharedPtr),
                      void
                      (*cb6) (const msgs::msg::FlagInfo::SharedPtr),
                      void
                      (*cb7) (const std_msgs::msg::String::SharedPtr),
                      void
                      (*cb8) (const msgs::msg::FlagInfo::SharedPtr),
                      void
                      (*cb9) (const std_msgs::msg::Int32::SharedPtr),
                      void
                      (*cb10) (const sensor_msgs::msg::Imu::SharedPtr),
                      void
                      (*cb11) (const std_msgs::msg::Bool::SharedPtr),
                      void
                      (*cb12) (const msgs::msg::BackendInfo::SharedPtr),
                      void
                      (*cb13) (const std_msgs::msg::String::SharedPtr),
                      void
                      (*cb14) (const msgs::msg::DetectedObjectArray::SharedPtr),
                      void
                      (*cb15) (const std_msgs::msg::String::SharedPtr),
                      void
                      (*cb16) (const msgs::msg::FlagInfo::SharedPtr),
                      void
                      (*cb17) (const msgs::msg::FlagInfo::SharedPtr),
                      bool isNewMap)
    {
      ...
      if(isNewMap){
        ...
        gnss2local_sub = n->create_subscription<geometry_msgs::msg::PoseStamped>("veh_info", 1, cb4);
      }else{
      ...
      rclcpp::Subscription<std_msgs::msg::String>::SharedPtr fps;
    ...
    static void
    publishOtherCar(msgs::msg::Obu input)
    {
    ...
    static void
    publishTraffic(std::string topic, msgs::msg::Spat input)
    {
    ...
    static void
    publishReserve(std::string topic, msgs::msg::StopInfoArray msg)
    {
    ...
    static void
    publishRoute(std::string topic, msgs::msg::RouteInfo msg)
    {
      //std::cout << "publishReserve topic " << topic  << std::endl;
